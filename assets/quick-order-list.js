  ...
  customElements.define(
    ...
    class QuickOrderList extends BulkAdd {
      constructor() {
        ...
        this.stickyHeaderElement = document.querySelector('#header');
        this.getTableHead();
        this.getTotalBar();
      ...
      getSectionsToRender() {
        return [
          ...
          {
            id: `shopify-section-${document.querySelector('cart-drawer').dataset.id}`,
            selector: '#CartDrawer',
      ...
      renderSections(parsedState, ids) {
        ...
        this.getSectionsToRender().forEach((section) => {
          ...
          if (
            ...
            sectionElement.parentElement.classList.contains('ctdrawer')
          ) {
